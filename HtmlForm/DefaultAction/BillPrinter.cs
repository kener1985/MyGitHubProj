...
namespace DefaultAction
{
    class BillPrinter
    {
        ...
        public static void Print(DataTable tbl, StrDictionary sd)
        {
            ...
            .AppendLine("<style type=\"text/css\"> body{font-family:\"Times New Roman\",Georgia,Serif;margin:2px;padding:0px;} .myTable,.myTable td,th {margin:0;font-size:16px;border:1px solid #000;border-collapse:collapse;height:19px;}</style>")
            ...
            .AppendLine("<div style=\"width:700px;margin:0;padding:0;\"><center><b style=\"font-size:28px\">金煌建材结算单</b><br/>")
            .AppendLine("<span style=\"font-size:14px\">电话：0663-3590487 传真：0663-3592395<br/>")
            .AppendLine("地址：揭阳市蓝城区霖磐街道联西村(蓝城公安斜对面)</span><br/>")
            .AppendLine("<div style=\"font-size:16px;text-align:left;margin:2px 0 2px 2px;width:680px;border:0px red solid;\">")
            .AppendLine("<div style=\"border:0px red solid;width:450px;float:left;\">购货单位:")
            .Append(sd["purunit"]).Append("</div>日期:").Append(date).Append("&nbsp;&nbsp;&nbsp;&nbsp;页码:").Append(sd["pagecode"]).
